...
Устранение технического долга можно сравнить с лечением болезни, где первый шаг к выздоровлению - признание себя больным. Каждый участник нашего проекта признаёт наличие (и, что более серьёзно, нарастание) технического долга. Попытки справиться с техническим долгом в одиночку сравнимы с боем с ветряными мельницами. Если есть **осознание** проблемы - есть и её решение. Устранение технического долга требует исключительно системного подхода.
...
| 9. Отсутствие автоматизации |Ввиду отсутствия тестов, отсутствует и их автоматизация (логично). При этом сборка и развёртывание приложения автоматизированы.  |
